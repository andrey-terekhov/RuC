...
tablesandtree(ruc_context *context)
{
    ...
    */
    ...
    while (i < context->tc)
    {
        ...
        {
            case TFuncdef:
                printer_printf(&context->output_options, "TFuncdef funcn= %i maxdispl= %i\n",
            ...
            case TConstd:
                ...
                break;
            case TSliceident:
                printer_printf(&context->output_options, "TSliceident displ= %i type= %i\n",
                        context->tree[i], context->tree[i + 1]);
                i += 2;
                break;
            case TSlice:
                printer_printf(&context->output_options, "TSlice elem_type= %i\n",
                        context->tree[i++]);
                break;
            case TSelect:
            ...
            case COPYST:
                ...
                printer_printf(&context->output_options, "(%i)", context->tree[i++]); // length
                printer_printf(&context->output_options, "(%i)\n",
    ...
    while (i < context->pc)
    {
        ...
        switch (context->mem[i++])
        {
            ...
            case BEGINIT:
                ...
                break;
            case STRUCTWITHARR:
                printer_printf(&context->output_options, "STRUCTWITHARR displ= %i ",
                        context->mem[i++]);
            ...
            case DEFARR:
                ...
                printer_printf(&context->output_options, "usual= %i ",
                        context->mem[i++]); // usual
                printer_printf(&context->output_options, "all= %i ", context->mem[i++]); // all
                printer_printf(&context->output_options, "instruct= %i\n",
                        context->mem[i++]); // instruct
                break;
            case ARRINIT:
                printer_printf(&context->output_options, "ARRINIT N= %i ", context->mem[i++]);
                printer_printf(&context->output_options, "elem_len= %i ", context->mem[i++]);
                printer_printf(&context->output_options, "displ= %i ", context->mem[i++]);
                printer_printf(&context->output_options, "usual= %i\n", context->mem[i++]);
                break;
                //            case STRUCTINIT:
                //                printer_printf(&context->output_options, "STRUCTINIT N= %i ",
                //                context->mem[i++]);
                //            break;
            case NOP:
                printer_printf(&context->output_options, "NOP\n");
            ...
            case COPYST:
                printer_printf(&context->output_options, "COPYST %i ",
                        context->mem[i++]); // displ
                printer_printf(&context->output_options, "(%i)", context->mem[i++]); // length
                printer_printf(&context->output_options, "(%i)\n",
            ...
            case SLICE:
                ...
                break;
            case SELECT:
                printer_printf(&context->output_options, "SELECT field_displ= %i\n",
                        context->mem[i++]);
                break;
            case WIDEN:
            ...
            case FUNCBEG:
                printer_printf(&context->output_options, "FUNCBEG maxdispl= %i ",
                        context->mem[i++]);
