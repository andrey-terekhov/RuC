...
static inline void default_log(const char *const tag, const char *const msg, const uint8_t color,
                               const char *const tag_log)
{
    set_color(COLOR_TAG);
...
static inline void log_main(const logger func, const char *const tag, const char *const msg, const char *const line,
                            const size_t symbol)
{
