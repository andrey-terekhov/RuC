...
#define REMASSAT \
    9012 // эти 22 операции с присваиванием оставляют значение на стеке
...
#define REMASSATV \
    9212 // а эти 22 операции с присваиванием не оставляют значение на стеке
...
#define LOADD 9458
#define LAT \
    9459 // это L@, т.е. адрес ячейки на вершине стека заменить ее значением
#define LATD \
    9460 // на вершине стека адрес вещественного значения, которое надо положить
         // на стек
#define STOP 9461
#define SELECT \
    9462 // операнд - смещение, которое эта команда добавит к верхушке стека
